...
| **ruleset=JSON_STRING**                     | String containing a [JSON ruleset]((https://codenarc.github.io/CodeNarc/codenarc-creating-ruleset.html#creating-a-json-ruleset-file)) content. <br/> The string must be URL-encoded in UTF-8 before being sent as argument to CodeNarc                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -ruleset="\{ 'Println'\: \{ \} \}"                                   |
