...
class TrailingCommaRuleTest extends AbstractRuleTestCase<TrailingCommaRule> {
    ...
    class List {
        ...
        @Test
        void NoViolationsOnCheckListFalse() {
            final SOURCE = '''
                int[] array = [1,
                               2
                              ]
        ...
        @Test
        void SingleElementList_ignoreSingleElementListTrue_NoViolations() {
            final SOURCE = '''
                int[] array1 = [[1,
                               2,
                               ]
        ...
        @Test
        void SingleElementList_ignoreSingleElementListFalse_Violations() {
            final SOURCE = '''
                int[] array1 = [[1,
                               2,
                               ]
        ...
        @Test
        void NoTrailingComma_LastElementFollowedByBraceOnTheSameLine_NoViolation() {
            final SOURCE = '''
                int[] array1 = [1,
                               2]
            '''
        ...
        @Test
        void NoViolationForInlineListInAnAnnotation() {
            final SOURCE = '''
                 @ToString(
                    ignoreNulls = false,
        ...
        @Test
        void NoViolationForMultiLineListInAnAnnotation() {
            final SOURCE = '''
                 @ToString(
                    ignoreNulls = false,
                    excludes = [
        ...
        @Test
        void SingleViolationInAnAnnotation() {
            final SOURCE = '''
                 @ToString(
                    ignoreNulls = false,
                    excludes = [
    ...
    class Map {
        ...
        @Test
        void NoViolationsOnCheckMapFalse() {
            final SOURCE = '''
                def map = [a:1
                          ]
            '''
        ...
        @Test
        void NoViolationForMapInConstructorOverMultipleLines() {
            final SOURCE = '''
        ...
        @Test
        void SingleElementMap_ignoreSingleElementMapTrue_NoViolations() {
            final SOURCE = '''
                def map1 = [a:[1,
                               2,
                               ]
        ...
        @Test
        void SingleElementMap_ignoreSingleElementMapFalse_Violations() {
            final SOURCE = '''
                def map1 = [a:1
                              ]
                def map2 = [
        ...
        @Test
        void MapFunctionCallParameters_NoViolation() {
            final SOURCE = '''
                node('something') {
                  stage('whatever') {
                    myLib.someFunction(
        ...
        @Test
        void MapFunctionCallParameters_Violation() {
            final SOURCE = '''
                node('something') {
                  stage('whatever') {
                    myLib.someFunction(
