...
/**
 * Tests for SynchronizationOnBoxedPrimitiveRule
 *
 * @author Hamlet D'Arcy
 * @version $Revision: 329 $ - $Date: 2010-04-29 04:20:25 +0200 (Thu, 29 Apr 2010) $
 */
class SynchronizationOnBoxedPrimitiveRuleTest extends AbstractRuleTestCase {

    void testRuleProperties() {
        assert rule.priority == 2
        assert rule.name == "SynchronizationOnBoxedPrimitive"
    }
    ...
    protected Rule createRule() {
        new SynchronizationOnBoxedPrimitiveRule()
    }
}