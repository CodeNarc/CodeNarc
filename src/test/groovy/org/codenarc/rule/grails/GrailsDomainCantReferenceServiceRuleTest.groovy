...
/**
 * Tests for GrailsDomainCantReferenceServiceRule
 *
 * @author Artur Gajowy
 */
class GrailsDomainCantReferenceServiceRuleTest extends AbstractRuleTestCase {

    @Test
    void testRuleProperties() {
        assert rule.priority == 2
        assert rule.name == 'GrailsDomainCantReferenceServiceRule'
    }
    ...
    protected Rule createRule() {
        new GrailsDomainCantReferenceServiceRule()
    }
}