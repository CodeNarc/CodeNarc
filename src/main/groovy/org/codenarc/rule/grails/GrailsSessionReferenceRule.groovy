 ...
 * to this rule by configuring the <code>doNotApplyToFilenames</code> property of the rule. 
 * <p/>
 ...
 */
public class GrailsSessionReferenceRule extends AbstractAstVisitorRule {
    static final FILES_TO_CHECK = /.*grails-app\/(controllers|taglib)\/.*/

    String name = 'GrailsSessionReference'
    int priority = 2
    Class astVisitorClass = GrailsSessionReferenceAstVisitor
    String applyToFilesMatching = FILES_TO_CHECK
}
