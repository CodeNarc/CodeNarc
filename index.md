...
<tr>
     ...
     <td class="section">
         ...
         <ul>
              <li>Java 17 or later for the default CodeNarc artifact (Groovy 5); Java 1.8 or later for the Groovy 4-compatible variant</li>
              <li><a href="http://groovy-lang.org/">Groovy</a> 4.0 or later</li>
