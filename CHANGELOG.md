...
RuleSets
 - #548: Allow to use RuleSets in JSON format ([Nicolas Vuillamy](https://github.com/nvuillam))
 - #548: Allow to send XML and JSON RuleSets as string arguments ([Nicolas Vuillamy](https://github.com/nvuillam))
